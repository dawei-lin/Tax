  		...
  		$.ajax({
  			...
  			success:function(msg){
  				if("信息状态改变"!=msg){
  					...
  					if(state==1){
  					$("#show_"+id).html("发布");
  					$("#change_"+id).html('<a href="javascript:doPublic(\''+id+'\',0)">停用</a>');
  					}else{
  					$("#show_"+id).html("停用");
  					$("#change_"+id).html('<a href="javascript:doPublic(\''+id+'\',1)">发布</a>');
  					}
                    ...
                    <table width="100%" border="0">
                        ...
                        <s:iterator value="pageResult.items" status="st">
                            <tr <s:if test="#st.odd"> bgcolor="f8f8f8" </s:if> >
                                ...
                                <td align="center">
                                	<s:property value="#type_map[type]"/>	
                                </td>
                                ...
                                <td align="center">
                                	<span id="change_<s:property value='infoId'/>">
                                		<s:if test="state==1">
