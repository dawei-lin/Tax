...
<form id="form" name="form" action="${basePath }nsfw/complain/complain_deal.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:property value="complain.toCompContent"/></td>
        </tr>
