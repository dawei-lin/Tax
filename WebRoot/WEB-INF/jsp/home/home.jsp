            ...
            <table width="98%" border="0" align="center">
                <tr>
                    <td width="76" height="100" align="center" valign="middle">
                        <div class="left-tx">
                            <s:if test="%{#session.user.headImg != null && #session.user.headImg !=''}">
                            	<img src="${ctx}/upload/<s:property value='#session.user.headImg'/>" width="70" height="70" />
                            </s:if><s:else>
                    ...
                    <td width="60%"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="2" style=" font-weight:bold; color:#3a7daa;"><s:property value="#session.user.name"/></td>
                        </tr>
                        <tr>
        ...
        <div class="left_grzx1">
            ...
            <table width="98%" border="0" align="center">
                ...
                <tr>
                    ...
                    <td width="150px"><s:property value="#type_map[type]"/></td>
    ...
    <div class="layout_center">
        <div class="lc_grzx1">
            ...
            <table width="98%" border="0" align="center">
                ...
                <tr>
                	...
                	<s:param name="complain.compId">
                	<s:property value="compId"/>
                	</s:param>
                	</s:url>
                    <td height="23">
                    <s:a href="%{#compViewUrl}" target="_blank">
                    <s:property value="toCompTitle"/>
                    </s:a>
                    </td>
                    <td width="180px"><s:property value="#complainStateMap[compState]"/></td>
                    <td width="180px"><s:property value="isNm?'匿名':'非匿名'"/></td>
                    <td width="180px"><s:date name="compDate" format="yyyy-MM-dd HH:mm"/></td>
                </tr>
                </s:iterator>
            </table>
        </div>
        ...
        <div class="lc_grzx1">
            <div class="lc_grzxbt">
                <h1>我的咨询</h1>
                <div style="float:right;padding-top:3px;">
                	<s:a action="home_reserveAddUI" namespace="/sys">我要预约</s:a>&nbsp;&nbsp;
                </div>
            </div>
            <table width="98%" border="0" align="center">
                <tr>
